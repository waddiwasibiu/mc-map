...
},
{
    ...
    coordinates: {
        server1: [
            { id: 1, x: -9164, y: 192, z: -2182, description: "芙兰" },
            { id: 2, x: -5782, y: 192, z: 3527, description: "芙兰" },
            { id: 3, x: -3002, y: 192, z: -9852, description: "菲亚" },
            { id: 4, x: 4833, y: 192, z: 870, description: "缘小小村" },
            { id: 5, x: 1820, y: 192, z: -57, description: "柔馨镇" },
            { id: 6, x: 8845, y: 192, z: 8118, description: "宁冰 (已改造)" },
            { id: 7, x: -2390, y: 192, z: -5020, description: "雨眠" },
            { id: 8, x: -1774, y: 192, z: -8792, description: "菲亚" },
            { id: 9, x: 10646, y: 192, z: -220, description: "菲亚" },
            { id: 10, x: -7356, y: 192, z: 9040, description: "爱酱" },
            { id: 11, x: -10900, y: 192, z: -9507, description: "爱酱" },
            { id: 12, x: 11850, y: 192, z: 3845, description: "爱酱" },
            { id: 13, x: 5658, y: 192, z: 11757, description: "爱酱" },
            { id: 14, x: -11094, y: 192, z: 3811, description: "爱酱" },
            { id: 15, x: -975, y: 192, z: -10994, description: "爱酱" },
            { id: 16, x: 3896, y: 192, z: -10653, description: "爱酱" },
            { id: 17, x: 2625, y: 192, z: -336, description: "爱酱" },
            { id: 18, x: 12348, y: 192, z: 2721, description: "爱酱" },
            { id: 19, x: 2928, y: 192, z: -11479, description: "爱酱" },
        ],
        server2: [
            { id: 1, x: 6562, y: 192, z: -9506, description: "小贼猫" },
            { id: 2, x: -9795, y: 192, z: 3234, description: "七月" },
            { id: 3, x: 2305, y: 192, z: 8814, description: "爱酱" },
            { id: 4, x: -1689, y: 192, z: 8335, description: "芙兰" },
            { id: 5, x: 9493, y: 192, z: 3317, description: "爱酱" },
            { id: 6, x: -5274, y: 192, z: -8951, description: "dale" },
            { id: 7, x: 10001, y: 192, z: -8182, description: "菲亚" },
            { id: 8, x: -9055, y: 192, z: -3178, description: "爱酱" },
            { id: 9, x: -8716, y: 192, z: -1668, description: "爱酱" },
            { id: 10, x: -6037, y: 192, z: -9784, description: "dale" },
            { id: 11, x: 7292, y: 192, z: 6267, description: "小戴" },
            { id: 12, x: 9237, y: 192, z: -10252, description: "菲亚" },
            { id: 13, x: -5661, y: 192, z: 12136, description: "爱酱" },
            { id: 14, x: -6520, y: 192, z: 9935, description: "爱酱" },
            { id: 15, x: 5588, y: 192, z: -3884, description: "菲亚" },
            { id: 16, x: -8070, y: 192, z: -10888, description: "爱酱" },
            { id: 17, x: -10937, y: 192, z: 4285, description: "爱酱" },
            { id: 18, x: 5806, y: 192, z: -3884, description: "wintersunglow" },
            { id: 19, x: -5316, y: 192, z: 10691, description: "爱酱" },
            { id: 20, x: 11033, y: 192, z: -6270, description: "爱酱" },
            { id: 21, x: -10152, y: 192, z: -9533, description: "Skeeping_beauty_" },
            { id: 22, x: -8583, y: 192, z: -10240, description: "爱酱" },
        ]
    }
},
{
...

{
    ...
    coordinates: {
        server1: [
            ...
            { id: 18, x: 8045, y: 192, z: -1548, description: "地狱坐标" },
            { id: 19, x: 88, y: 192, z: -7992, description: "地狱坐标" },
            { id: 20, x: 24, y: 192, z: 12037, description: "地狱坐标" },
            { id: 21, x: 2438, y: 192, z: 12016, description: "地狱坐标" },
        ],
        server2: [
            ...
            { id: 19, x: 11196, y: 192, z: -7970, description: "地狱坐标" },
            { id: 20, x: 9612, y: 192, z: -11162, description: "地狱坐标" },
            { id: 21, x: 11234, y: 192, z: -2329, description: "地狱坐标" },
            { id: 22, x: 11256, y: 192, z: 9663, description: "地狱坐标" },
            { id: 23, x: 4032, y: 192, z: 11222, description: "地狱坐标" },
            { id: 24, x: 848, y: 192, z: 11223, description: "地狱坐标" },
            { id: 25, x: -3191, y: 192, z: 11213, description: "地狱坐标" },
            { id: 26, x: 12023, y: 192, z: 48, description: "地狱坐标" },
            { id: 27, x: 4042, y: 192, z: 11997, description: "地狱坐标" },
            { id: 28, x: 5610, y: 192, z: 12004, description: "地狱坐标" },
            { id: 29, x: 8000, y: 192, z: 12080, description: "地狱坐标" },
            { id: 30, x: 3648, y: 192, z: 4380, description: "地狱坐标" },
            { id: 31, x: 2420, y: 192, z: 12026, description: "地狱坐标" },
        ]
    }
},
...

{
    ...
    coordinates: {
        server1: [
            ...
            { id: 7, x: -22814, y: 192, z: -11940, description: "地狱坐标" },
            { id: 8, x: -22678, y: 192, z: -11946, description: "地狱坐标" },
            { id: 9, x: -21812, y: 192, z: -9570, description: "地狱坐标" },
            { id: 10, x: -16486, y: 192, z: -5824, description: "地狱坐标" },
...

{
    ...
    coordinates: {
        server1: [
            ...
            { id: 30, x: -3570, y: 192, z: -9990, description: "地狱坐标 米夏跑图发现" },
        ...
        server2: [
            ...
            { id: 32, x: 7604, y: 192, z: -7600, description: "地狱坐标" },
            { id: 33, x: 7601, y: 192, z: -10390, description: "地狱坐标" },
        ]
    }
},
...

{
    ...
    coordinates: {
        server1: [
            ...
            { id: 5, x: 450, y: 192, z: -2550, description: "天才粉毛甄选真坐标" },
            { id: 6, x: -31200, y: 192, z: -67777, description: "天才粉毛甄选真坐标" },
            { id: 7, x: 4222, y: 192, z: 555, description: "天才粉毛甄选真坐标" },
            { id: 8, x: -1200, y: 192, z: 4320, description: "天才粉毛甄选真坐标" },
            { id: 9, x: -9329, y: 192, z: -20081, description: "菲亚甄选真坐标" },
            { id: 10, x: -21615, y: 192, z: -36573, description: "菲亚甄选真坐标" },
            { id: 11, x: -37891, y: 192, z: -76070, description: "菲亚甄选真坐标" },
            { id: 12, x: -5414, y: 192, z: 2007, description: "地狱坐标" },
            { id: 13, x: -7706, y: 192, z: 164, description: "地狱坐标" },
        ],
        server2: [
            ...
            { id: 13, x: -48750, y: 192, z: 8600, description: "天才粉毛甄选真坐标" },
            { id: 14, x: -3472, y: 192, z: 14123, description: "天才粉毛甄选真坐标" },
            { id: 15, x: -2333, y: 192, z: 15100, description: "天才粉毛甄选真坐标" },
            { id: 16, x: -11740, y: 192, z: 22022, description: "天才粉毛甄选真坐标" },
            { id: 17, x: 6100, y: 192, z: 11400, description: "地狱坐标" },
        ]
    }
},
